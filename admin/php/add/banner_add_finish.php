...
$banner_class=$_POST["banner_class"];
...
if (isset($file_pc_url)){
    ...
    $sql_banner = "INSERT INTO banner (banner_title, banner_alt, banner_img_url, banner_class, banner_website) VALUES('{$banner_title}', '{$banner_alt}', '{$img_pc_url}', '{$banner_class}', '{$banner_website}')";
 
    $sqlfinish = mysqli_query($link,$sql_banner);
}
else {
    $sql_banner = "INSERT INTO banner (banner_title, banner_alt, banner_class, banner_website) VALUES('{$banner_title}', '{$banner_alt}', '{$banner_class}', '{$banner_website}')";
    $sqlfinish = mysqli_query($link,$sql_banner);
}
