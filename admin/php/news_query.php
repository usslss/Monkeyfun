...
$sqlmsg = "SELECT news_id, news_title, news_summary, news_all ,news_click, news_class ,news_source, news_addtime ,news_img_url FROM news WHERE news_class LIKE '{$query_newsclass}'";
