...
<div class="x-body">
 <form action="page_edit_upload.php" method="post" enctype="multipart/form-data">
                ...
                <table class="layui-table" >
                  ...
                  <input type="text" style="width:700px" name="page_title" required="" lay-verify="required"
    ...
    <!--  -->                        
                  <input type="text" style="width:700px" name="page_keywords" required="" lay-verify="required"
                  ...
                  <td colspan="1"  width="100">  <?php echo $page_website;?>           
                        ...
                        <tr>
                            <th colspan="1">描述</th>
                            <td colspan="3">
                  <textarea name="page_description" style="width:700px" required lay-verify="required" placeholder="请输入" class="layui-textarea"><?php echo $page_description;?></textarea>
                  </td>
