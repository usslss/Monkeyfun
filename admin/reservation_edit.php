...
<div class="x-body">
 <form action="reservation_edit_upload.php" method="post" enctype="multipart/form-data">
                ...
                <table class="layui-table" >
                    <tbody >
                    <input type="hidden" value="<?php echo $reservation_id;?>" name="reservation_id"></input>
                    <tr>
                            <th width="100" colspan="1">预约姓名</th>
                            <td colspan="1" >
                            	<div class="layui-input-inline">
                  				<input type="text" style="width:400px" name="reservation_name" required="" lay-verify="required" autocomplete="off" class="layui-input" value="<?php echo $reservation_name;?>">
              					</div>
              				</td>
...
?> 
                  ...
                  <tr>	
                    ...
                    <td colspan="3" width="400">
                    	<div class="layui-input-inline">
                  		<input type="text" style="width:400px" name="reservation_idnum" required="" lay-verify="required" autocomplete="off" class="layui-input"  value="<?php echo $reservation_idnum;?>">
                  		</div>
                  	</td>                 	
                  </tr>  
                  ...
                  <tr>	
                    ...
                    <td colspan="3" width="400">
                    	<div class="layui-input-inline">
                  		<input type="text" style="width:400px" name="reservation_phone" required="" lay-verify="required" autocomplete="off" class="layui-input"  value="<?php echo $reservation_phone;?>">
                  		</div>
                  	</td>                 	
                  </tr>  
                  ...
                  <tr>	
                    ...
                    <td colspan="3" width="400">
                    	<div class="layui-input-inline">
                  		<input type="text" style="width:400px" name="reservation_address" required="" lay-verify="required" autocomplete="off" class="layui-input"  value="<?php echo $reservation_address;?>">
                  		</div>
                  	</td>                 	
                  </tr>
                  ...
                  <tr>	
                    ...
                    <td colspan="3" width="400">
                    	<div class="layui-input-inline">
                  		<input type="text" style="width:400px" name="reservation_addtime" required="" lay-verify="required" autocomplete="off" class="layui-input"  value="<?php echo $reservation_addtime;?>">
                  		</div>
                  	</td>                 	
                  </tr>
