...
<script>
    ...
    layui.use('table', function(){
        ...
        table.render({
            elem: '#LAY_table_user'
            ,url: 'php/news_query.php'
            ,method: 'get'
            ,where: {news_class: '<?php echo $query_news_class;?>',xx:5 }
            ,cols: [[
 ...
 //               ,{field:'news_img_url', title: '新闻摘要配图', sort: true, fixed: false}
            
                ,{field:'news_class', title: '新闻分类', sort: false, fixed: false,width:150}
//                ,{field:'news_url', title: '新闻url', sort: true, fixed: false}               
                ,{field:'news_source', title: '新闻来源', sort: true, fixed: false,width:100}
...
//js实现条件搜索传值的地方
        ...
        table.on('tool(useruv)', function(obj){
            ...
            if(obj.event === 'edit'){
                ...
                var c='news_edit.php?news_id='+data.news_id;
